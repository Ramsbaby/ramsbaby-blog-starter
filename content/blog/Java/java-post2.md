...
또한 수업에 불참해 교수님의 설명을 듣지 못한 학생이라도, 이 설계도만 보더라도 어떤 형식으로 논문을 제출해야할 지 알게될 것입니다. <br><br>
...
위의 두 동물은 Animal이라는 추상클래스(공통클래스)를 상속 받았기 때문에 brath()라는 숨쉬는 기능은 공통으로 가지고 있습니다.<br>
