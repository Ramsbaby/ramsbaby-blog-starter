...
안녕하세요, 퇴사 후 오랜 방황을 마치고 돌아온 람스베이비 입니다. 🖐

제가 오랫동안 바래오던 오픈소스 기여에 드디어 발돋움을 하였습니다. 🎈

지금 보고계시는 블로그 프로젝트를 이제 제 개인 깃허브 계정에서 공식 깃허브 계정으로 옮겨서 오픈을 하였습니다.

작년 2020년 6월부터 개인적으로 리액트 공부를 진행하며, 서브로 진행하던 블로그 프로젝트가 드디어 많은 손을 거쳐서 지금의 모습으로 재탄생하였습니다.

혼자 진행하기엔 벅찬 감이 있어서, 열심히 개발중이던 다른 개발자친구 한명을 꼬드겨서 리앤장 갯츠비 블로그 스타터 라는 약간 긴 이름의 오픈소스 프로젝트를 시작하였습니다.
